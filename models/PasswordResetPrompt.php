...
class PasswordResetPrompt extends Model {
    private $id;
    private $id_user;
    private $identifier;
    private $valid_from;
    ...
    public static function createResetPrompt($user, $identifier) {
        $instance = new self();
    ...
    public function setValidTo($valid_to): self
    {
        ...
        DbAdapter::editAttributeInObject('password_reset_prompt', 'valid_to', $valid_to, $this->id, 'id');
